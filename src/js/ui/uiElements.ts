...
export const getFlickToSelectToggle = () => document.getElementById('flick-to-select-toggle');
...
export const getMessageContainer = () => document.getElementById('sync-status-message');
